...
class GameData {	
	// 游戏元素类型
	public static GameElementTypes:string[] = ["Egret-iOS-Support","EgretEngine","EgretWing","EgretFeather","DragonBones","EgretNative","Lakeshore","Egret-Android-Support","TextureMerger","EgretiaServer","EgretUIEditor","EgretInspector","EgretPro","ResDepot"];
	// 条件元素类型及其对应的数量
